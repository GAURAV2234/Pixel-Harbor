...
from tkinter import Label, Frame, Scrollbar, Canvas, Button
from PIL import Image, ImageFilter, ImageEnhance
import numpy as np
import cv2
from tkinter import filedialog

# Import operations from operations.py
...
class ImageProcessingApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("Operations Overview")
        ...
        for F in (OperationPage,):
            frame = F(container, self)
            self.frames[F] = frame
            frame.grid(row=0, column=0, sticky="nsew")

        self.show_frame(OperationPage)
